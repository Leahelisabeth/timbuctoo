...
public class HuygensIng {
  ...
  public static Vres mappings = new Vres.Builder()
    ...
    .withCollection("locations", c -> c
      .withDisplayName(localProperty("names", defaultLocationNameConverter))
      .withProperty("^names", localProperty("names")))
    .withCollection("events", c -> c
        .withDisplayName(localProperty("name"))
        .withProperty("name", localProperty("event_name")))
    ...
    .withVre("EuropeseMigratie", "em", vre -> vre
      .withCollection("emmigrantunits", coll -> coll
        ...
        .withDisplayName(localProperty("emmigrantunit_achternaam"))
        ...
        .withProperty("hasUnit", localProperty("emmigrantunit_unit", numberToInt))
        ...
        .withProperty("adresAantal", localProperty("emmigrantunit_adresAantal", numberToInt))
        .withProperty("eventsAantal", localProperty("emmigrantunit_eventsAantal", numberToInt))
      )
      .withCollection("emcards", coll -> coll
        .withAbstractType("document")
        .withDisplayName(localProperty("emcard_cardnumber"))
        .withProperty("kaartnummer", localProperty("emcard_cardnumber"))
        .withProperty("jaartal_begin", localProperty("emcard_yearStart", numberToInt))
        .withProperty("jaartal_eind", localProperty("emcard_yearEnd", numberToInt))
      )
      .withCollection("emtravels", coll -> coll
        .withAbstractType("event")
        .withDisplayName(localProperty("emtravel_type"))
        .withProperty("type_reis", localProperty("emtravel_type"))
        .withProperty("start", localProperty("emtravel_start", numberToInt))
        .withProperty("eind", localProperty("emtravel_eind", numberToInt))
      )
      .withCollection("emwaardeoordeels", coll -> coll
        .withAbstractType("event")
        .withDisplayName(localProperty("emwaardeoordeel_waardeoordeelemigrant"))
        .withProperty("waardeoordeelemigrant", localProperty("emwaardeoordeel_waardeoordeelemigrant"))
        .withProperty("oordeel", localProperty("emwaardeoordeel_oordeel"))
      )
      .withCollection("emimages", coll -> coll
        .withAbstractType("document")
        .withDisplayName(localProperty("emimage_image"))
        .withProperty("Image", localProperty("emimage_image"))
      )
      .withCollection("emevents", coll -> coll
        .withAbstractType("event")
        .withDisplayName(localProperty("emevent_remark"))
        .withProperty("remark", localProperty("emevent_remark"))
        .withProperty("day", localProperty("emevent_day", numberToInt))
        .withProperty("month", localProperty("emevent_month", numberToInt))
        .withProperty("year", localProperty("emevent_year", numberToInt))
      )
      .withCollection("emactors", coll -> coll
        .withAbstractType("person")
        .withDisplayName(localProperty("emactor_achternaam"))
        .withProperty("nr", localProperty("emactor_nr"))
        .withProperty("achternaam", localProperty("emactor_achternaam"))
        .withProperty("voorletters", localProperty("emactor_voorletters"))
        .withProperty("tussenvoegsel", localProperty("emactor_tussenvoegsel"))
        .withProperty("opschrift", localProperty("emactor_opschrift"))
        .withProperty("functie", localProperty("emactor_functie"))
        .withProperty("jaar", localProperty("emactor_jaar", numberToInt))
        .withProperty("plaatsing", localProperty("emactor_plaatsing"))
        .withProperty("bijzonderheden", localProperty("emactor_bijzonderheden"))
      )
      .withCollection("emactorinstitutions", coll -> coll
        .withAbstractType("collective")
        .withDisplayName(localProperty("emactorinstitution_naam"))
        .withProperty("nr", localProperty("emactorinstitution_nr"))
        .withProperty("naam", localProperty("emactorinstitution_naam"))
        .withProperty("functie", localProperty("emactorinstitution_functie"))
        .withProperty("jaar", localProperty("emactorinstitution_jaar"))
        .withProperty("plaatsing", localProperty("emactorinstitution_plaatsing"))
        .withProperty("bijzonderheden", localProperty("emactorinstitution_bijzonderheden"))
      )
      .withCollection("emeventtypes", coll -> coll
        .withAbstractType("thing")
        .withProperty("naam", localProperty("emeventtype_naam"))
        .withDisplayName(localProperty("emeventtype_naam"))
      )
      ...
      .withCollection("emvervoermiddels", coll -> coll
        .withAbstractType("thing")
        .withDisplayName(localProperty("emvervoermiddel_vervoer"))
        .withProperty("vervoer", localProperty("emvervoermiddel_vervoer"))
      )
      .withCollection("emtypevervoers", coll -> coll
        .withAbstractType("keyword")
        .withDisplayName(localProperty("emtypevervoer_type_vervoer"))
        .withProperty("type_vervoer", localProperty("emtypevervoer_type_vervoer"))
      )
      .withCollection("emschemas", coll -> coll
        .withAbstractType("keyword")
        .withDisplayName(localProperty("emschema_naam"))
        .withProperty("Naam", localProperty("emschema_naam"))
      )
      ...
      .withCollection("emreligions", coll -> coll
        .withAbstractType("keyword")
        .withDisplayName(localProperty("emreligion_godsdienst"))
        .withProperty("Godsdienst", localProperty("emreligion_godsdienst"))
      )
